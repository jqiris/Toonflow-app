...
| 光线 | even soft light照明，no hard shadows，精准还原PBR材质质感，保留国风赛博道具自发光/能量光效的层次，不出现过曝 |
| 角度 | 与原设定图front view一致，确保中式核心纹样、赛博机能结构、核心接口在所有视图中完整呈现，无遮挡 |
...
| 标注 | 每种状态下方标注state name，字体不遮挡道具主体 |
...
基于{国风赛博prop name}设定图，Unreal Engine 5渲染，超高清8K，高精度3D建模，PBR物理材质，国风赛博朋克风格，中式传统形制与赛博机能结构完美融合，电影级光影，OC渲染，超写实质感，
{prop type：中式赛博兵器/灵能法器/数据信物/机能组件/改装器物等}，{核心material description}，{中式核心纹样/赛博核心结构描述}，
Current state：{state name}，{state visual description}，
{material surface change description}，{国风元素状态变化描述}，{赛博机能状态变化描述}，
纯prop still life展示，prop displayed independently，no one holding，no one wearing，无人握持，无任何人物肢体，
同一画面2x2 grid（2×2）固定布局：左上front view(front view)+右上side view(side view)+左下back view(back view)+右下detail closeup(detail closeup)，
素灰纯色#B8B8B8背景，even soft light，no hard shadows，无多余场景元素，
ultra-clear material texture，PBR材质精准还原，状态细节拉满，国风纹样与赛博结构细节可辨，
No text in image、标注、水印，
...
| R8 | 2x2 grid所有视图中，必须完整呈现道具的中式核心元素与赛博核心结构，无裁切、无遮挡 |
...
| X10 | 严禁修改2x2 grid固定布局，严禁裁切道具核心结构与纹样 |
