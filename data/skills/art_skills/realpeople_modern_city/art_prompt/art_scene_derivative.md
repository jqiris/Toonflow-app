...
| middle ground聚焦 | 50mm | 场景核心功能区/最具辨识度的局部 | 聚焦空间的"心脏"——办公室的工位区、咖啡厅的吧台、街道的交叉口 | 50mmmiddle ground聚焦、空间的核心叙事区域 |
...
| 标准全景→middle ground聚焦 | 材质质感、光线方向、color、使用痕迹 | 焦段收窄至50mm、裁切聚焦核心区域、景深适度变浅 |
| middle ground→近景细节 | 材质纹理、道具位置、光线方向 | 焦段85mm、极浅景深、背景自然虚化、突出空间中的叙事细节 |
...
| 多云/阴 | 柔光无硬影、整体偏冷灰、光线均匀 | 克制、平静、或是压抑的前兆 | 阴天柔光、no hard shadows、光线均匀漫射、整体偏灰冷调 |
...
| 晴→小雨 | 空间结构、建筑外观、物品位置 | 室外增加雨丝、玻璃添加真实雨痕、地面湿滑反光、color偏冷、植被挂水珠 |
| 晴→雪 | 空间结构、建筑外观、物品位置 | 增加飘雪/积雪、color偏冷白、暖光源的对比度提升、树枝/窗台积雪 |
...
| 景深 | 广角全貌→全景深f/8-f/11；middle ground→适度浅景深f/4-f/5.6；近景细节→浅景深f/2.8 |
...
{广角全貌/标准全景/middle ground聚焦/近景细节}，{24mm/35mm/50mm/85mm}，
保持原场景空间结构、陈设位置、光源逻辑不变，
{焦段描述}，{景深描述}，{构图聚焦区域描述}，
{时段+天气}，{光源行为描述}，
空间无人——严禁出现任何人物人影人体轮廓，
真实摄影画质、35mm full-frame photography、单张空间摄影
...
真人都市场景衍生摄影，基于原场景{场景名}的同一空间，
同一机位、同一焦段、同一时段——仅天气变化为{新weather}，
保持空间结构、物品位置完全不变，
{新weather的视觉特征：雨丝/雪/雾/湿地面/雨痕}，
{材质表面因weather产生的真实变化：金属水膜/玻璃雨痕/地面积水反光/植被挂水/积雪}，
{weather带来的情绪变化}，
空间无人——严禁出现任何人物人影人体轮廓，
真实摄影画质、单张空间摄影

> **使用说明**：焦段变体、时段变体、weather变体可单独使用也可组合使用（如"午后+小雨+middle ground"）。未涉及的维度在该条提示词中省略对应字段。
...
| R3 | weather变体必须同步适配材质表面的真实物理变化——玻璃雨痕/地面积水反光/植被挂水/积雪 |
| R4 | 必须是**单张**全景摄影——单视图、非2×2四视图、非多角度、非turnaround |
| R5 | 必须声明光源来源——光从哪儿来、色温多少、什么光源——不能是无来源的全局照明 |
| R6 | 必须保持原空间的使用痕迹——时段和weather衍变不能"洗掉"空间的磨损和岁月感 |
...
| X2 | 严禁「3D渲染 / 3D建模 / CG / UE引擎 / Blender / PBR材质 / volumetric lighting / AO」等一切CG术语 |
...
| X10 | 严禁「weather变体抹除空间的日常使用痕迹」——雨后的墙仍然是斑驳的、雪下的地面仍然有磨损 |
