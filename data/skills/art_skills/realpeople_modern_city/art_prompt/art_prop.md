...
5. **单视图静物摄影** — 道具以单张静物产品摄影方式独立呈现，非多角度建模展示，非2×22x2 grid
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 类型 | 咖啡杯/外卖餐盒/奶茶杯/便当盒/保温杯/玻璃水杯/餐具/便利店包装 | {餐饮prop type}，中国当代都市日常餐饮器皿 |
...
| 背景 | 素灰无缝背景纸 #B0B0B0（哑光），或纯白桌面/台面（浅木纹/米白桌面），根据道具属性选择。无多余物体、no decoration、no text |
| 光线 | 自然窗光或单灯柔光。窗光45°侧入（明亮柔和带自然阴影）、或柔光箱顶+侧补（产品摄影级均匀光线）。光影柔和、方向明确、no hard shadows |
...
真人都市道具实物产品摄影，单张still life display，非3D渲染非CG非建模，
{prop type}，{material description}，{外观细节——使用痕迹、中文标识、日常状态}，
...
| 编号 | 规则 |
|---|---|
| R1 | 必须是「单张静物摄影」——单视图、非多角度、非2×22x2 grid、非建模展示 |
