...
> 真人都市的场景不是"被建模的空间"，而是"被摄影机选中的真实场所"。没有渲染引擎、没有贴图、没有volumetric lighting参数——只有实际存在的光、真实的材料、以及中国城市的日常。
...
| 维度 | 摄影要求 | 提示词 |
|---|---|---|
| 风格 | 真实的中国当代都市室内空间——不是效果图、不是样板间、不是渲染。是有生活痕迹的真实室内 | 真实的中国当代都市{空间类型}、live-action photography、非效果图非样板间 |
| 光源逻辑 | 必须有明确的光源来源——窗光是哪个方向的窗、人工光是哪盏灯。光的方向和色温必须自洽 | {窗光方向}自然光为主、{人工光源}为辅、光的方向明确可追溯 |
| 空间层次 | 单张全景照片必须呈现前/中/background——foreground（门框/家具边缘/窗帘）形成画框感、middle ground是空间主体、background是空间延伸（另一个房间/窗外/走廊尽头） | foreground{画框元素}、middle ground{空间主体}、background{空间延伸}、广角镜头捕捉完整空间纵深 |
| 材质与表面 | 墙面有居住痕迹（污渍/贴纸残留/钉子孔）、地面有正常磨损、家具表面有使用包浆——一切材质呈现在摄影机下，非渲染 | 真实墙面使用痕迹、地面正常磨损、家具表面使用包浆、非全新非样板间 |
| 镜头选择 | 24-28mm广角——装下整个空间的广度、foreground到background的纵深全部清晰（全景深 f/8-f/11）、轻微桶形畸变增加空间感 | 广角24-28mm、全景深f/8-f/11、空间纵深完整、轻微透视增加空间感 |
...
| 咖啡厅/奶茶店 | 吧台+咖啡机、卡座/散座、落地窗+街景、暖调灯光、杯具+菜单 | 都市第三空间、松弛atmosphere、窗边座位的光 |
...
| 图书馆/书店 | 书架排列、阅读区+台灯、窗边座位、安静的atmosphere、翻旧的书籍 | 静谧安宁、翻书的声音、时间变慢 |
...
| 镜头选择 | 24-28mm广角（空间感强）或35mm（人眼感），全景深 f/8-f/11，画面包含完整的空间纵深，foreground到background全部清晰 | 广角24-35mm、全景深f/8-f/11、完整空间纵深、单张全景 |
...
| 构图 | 全景深大景别——foreground（门框/家具/护栏/树木/窗框）形成天然画框→middle ground是场地主体→background向空间纵深或窗外/天际线延伸 |
...
| 色彩 | 由实际光源的色温驱动，不套滤镜。色彩科学参考ARRI Alexa/Sony Venice电影color |
...
{indoor/outdoor}场景，中国当代都市真实{场景类型}，
{季节}，{时段}，{天气}，
{光源逻辑：窗光方向+人工光源/日光方向+城市光源}、光的方向和色温可追溯、非全局均匀光，
广角24-28mm镜头、全景深f/8-f/11、空间纵深完整、foreground到background全部清晰，
foreground{画框元素}、middle ground{空间主体结构}、background{空间延伸/窗外/远景}，
{材质与表面：墙面/地面/家具的真实使用痕迹}，
{都市瑕疵：磨损/斑驳/灰尘/落叶/积水——被使用过的痕迹}，
场景无人——{空场叙事线索}、严禁出现任何人物人影人体轮廓，
真实摄影画质、35mm full-frame photography、单张全景空间摄影，
Clean imageno textno watermarkno signatureno border
...
| R4 | 场景必须有前/中/background空间层次，foreground画框→middle ground主体→background延伸 |
| R5 | 必须有中国当代都市辨识度——中文标识/中国建筑风格/中国城市特征 |
| R6 | 必须有使用痕迹——墙面/地面/家具的自然磨损、非样板间非全新非效果图 |
| R7 | **严禁出现任何人物、人影、人体轮廓、剪影** |
| R8 | 必须声明"live-action photography + 非3D渲染非CG"核心锚定 |

### 严禁

| 编号 | 严禁 |
|---|---|
| X1 | 严禁「3D渲染 / 3D建模 / CG / UE引擎 / Blender / PBR材质 / volumetric lighting / AO」等一切CG术语 |
