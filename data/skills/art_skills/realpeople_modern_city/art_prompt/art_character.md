...
2. **素人感优先于明星感** — 都市叙事需要的是"看起来像你每天在地铁里会遇到的人"，而非"看起来像刚从杂志封面走下来的人"。bare-faced state下的真实面容优先于精致妆造
...
| 摄影关系 | 适合50mm近距离凝视、侧面光勾勒骨感、黑白color | — |
...
| 维度 | 摄影要求 | 提示词 |
|---|---|---|
| 肤色基调 | realistic Asian都市女性肤色范围：冷白至暖白，允许轻微肤色不均（颧骨偏红、眼周偏暗），这是真人的证据 | realistic Asian女性肤色、自然肤色不均、颧骨自然泛红、眼周真人质感 |
| 表面光泽 | 非哑光非油光——T区自然出油的反光、颧骨高点的自然高光，是皮肤"活着"的迹象 | natural skin glow、T区真实出油反光、活着而非建模的皮肤 |
...
| 维度 | 摄影要求 | 提示词 |
|---|---|---|
| 肤色基调 | realistic Asian都市男性肤色范围：冷白至健康小麦色，允许日晒色差（面部与颈部肤色自然过渡，T区较深、眼周较暗） | realistic Asian男性肤色、自然日晒色差、面部与颈部真实肤色过渡 |
...
| 身体比例 | realistic Asian女性身体比例，不过度拉长腿部，头身比接近现实（约6.5-7.5头身） | 真实的亚洲女性身体比例、自然的头身比、不拉长不缩小的写实身形 |
...
| 身体比例 | realistic Asian男性身体比例，不过度拉长腿部，头身比接近现实（约7-7.5头身） | 真实的亚洲男性身体比例、自然的头身比、写实而非漫画身形 |
...
| 发长与造型 | 按角色设定指定：齐耳短发/锁骨发/中长发/及腰长发/高马尾/低马尾/丸子头/慵懒盘发。基础状态为自然垂落，不加发饰、不编发 | {发长}、自然垂落/束起、no hair accessories、无编发、无夸张造型 |
...
| 严禁 | CGclear hair strands、假发套般整齐划一、无碎发、无风感僵硬、荧光染发 | — |
...
| 发质与纹理 | 真实的男性头发纹理——短发状态下头皮隐约可见、发丝有自然走向（发旋方向）、鬓角与胡茬自然过渡、额头碎发自然散落 | 真实短发纹理、头发自然走向、鬓角与胡茬的自然过渡、额头natural strands |
| 头皮可见 | 短发/板寸状态下头皮清晰可见，发际线自然（可能有轻微后退），头顶发旋自然 | 短发状态下头皮可见、自然发际线、真实发旋 |
| 严禁 | CGclear hair strands、假发感、发胶硬壳感、不自然的整齐边界 | — |
...
素色基础款上衣（圆领T恤/棉质衬衫/针织开衫）+ 基础款下装（直筒牛仔裤/棉质长裤/及膝半裙），颜色以黑/白/灰/米/藏蓝/卡其等都市日常基础色为主。面料可见自然纹理（棉的柔软褶皱、牛仔的斜纹肌理、针织的线圈纹理）。无品牌标识、无大面积印花、no decoration性设计。

### 男性基础服装

素色基础款上衣（圆领T恤/亨利领长袖/棉质衬衫）+ 基础款下装（直筒牛仔裤/棉质休闲裤），颜色以黑/白/灰/藏蓝/卡其等都市日常基础色为主。面料可见自然纹理（棉质的洗涤后微皱、牛仔的落色与磨损、衬衫领口的自然卷曲）。无品牌标识、无大面积印花、no decoration性设计。
...
| 位置 | 角度 | 景别 | 摄影要求 | 提示词 |
|---|---|---|---|---|
| 左一 | 正面近景 | 头顶至锁骨上缘 | 面部占据画面60%以上。镜头焦段50mm或85mm，浅景深（f/2.8-f/4），焦点在瞳孔。光影柔和均匀，眼中有自然高光点。完整呈现发际线到锁骨，no cropping of crown | portrait closeup, head to collarbone, shallow depth of field, eyes in sharp focus, natural catchlight, live-action photography |
...
| 背景 | seamless grey backdrop paper，色值约 #B0B0B0，无接缝、无渐变、无光斑、无投影。背景纸的轻微肌理可见，证明这是实拍而非渲染 |
...
| 光线 | 摄影棚标准柔光设置：前方大型柔光箱主光 + 双侧补光板反射。光影柔和、方向明确、no hard shadows、无阴阳脸。光比约1:2至1:3，保留面部立体感 |
...
{gender} human urban character portrait series, live-action photography, studio soft lighting, seamless grey backdrop, character reference sheet,
Same frame left to right: close-up + front full body + side full body + back full body,
{facial type description: face shape, eye shape, nose shape, lip shape, overall temperament}, natural bare-faced state, no makeup traces or only faint daily makeup, no facial markings, no stains, no blood,
{skin tone description}, realistic human skin texture, real pores, natural skin glow, non-retouched non-silicone,
{height description}, realistic Asian {male/female} body proportion, natural head-to-body ratio, natural daily standing pose, weight shifted not rigid,
{hair description}, real hair texture, natural strands and locks, natural hairline transition, semi-transparent hair strands under backlight,
{basic clothing description: solid color basic top + basic bottom}, {color}, real fabric texture visible, natural clothing wrinkles, no logo no print no decoration,
Four angles show the same person as continuous studio photography record,
Seamless grey backdrop paper #B0B0B0, even studio soft light, gentle contrast, no hard shadows, no pure black,
Clean image, no text, no watermark, no signature, no border,
Realistic human photography, 35mm full-frame photography, non-3D non-render non-CG non-drawing
...
| 编号 | 规则 |
|---|---|
| R1 | 必须是「原生bare-faced state」或仅极淡日常妆（无色唇膏、透明眉胶级别），禁止可见妆容 |
| R2 | 必须声明基础服装为「素色基础款日常着装」，无任何品牌标识、印花、图案、装饰性设计 |
| R3 | 必须声明「no hair accessories、no accessories、无首饰、no headwear、无纹身贴纸」 |
| R4 | 必须指定「seamless grey backdrop paper，无场景、无光斑、无渐变」 |
| R5 | 必须指定「四角度为同一人物的连续摄影记录」，面容/体型/发型/服装/光影完全呈现为同一次拍摄 |
| R6 | 全身角度必须从头顶到脚底完整入画，严禁裁切身体任何部位 |
| R7 | 近景特写必须从头顶到锁骨上缘完整入画，严禁裁切头顶 |
| R8 | 必须声明「live-action photography + non-3D non-render non-CGI」核心锚定 |
| R9 | 必须声明「真实皮肤质感 + non-retouched + 非硅胶假面」 |
