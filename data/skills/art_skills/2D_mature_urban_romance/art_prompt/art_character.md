...
| 造型 | 按角色身份推导：贵族/仙子/神祇→发簪步摇；武士→发冠束发；平民→自然散发/中分/偏分或简单束发 | 长发自然散落、柔顺长发 |
...
| 造型 | 按角色身份推导：都市时尚→简约发饰（发夹/发绳）；职场→简洁束发；休闲→自然散发或侧分 | 头发自然散落、侧分发型 |
...
{发色}{发长}，发丝层次分明，{基础造型}，{角色身份对应的发饰描述，贵族/帝王/神祇→发簪步摇/发冠；武士→束发；平民→自然散发或简单束发}，
