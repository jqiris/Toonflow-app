...
5. **非人类实体例外** — 若角色描述指向非人类生物（神兽/仙兽/动物等），则面容/肤感/发型/服装/人像特写等人类专用约束不适用，应直接依据角色描述生成该生物的视觉提示词，保留其物种特征、毛发/羽毛/鳞片质感、体型姿态、神性光环等，跳过人类专属规范
...
| 造型 | 按角色身份推导：贵族/仙子/神祇→发簪步摇；武士→发冠束发；平民→自然散发/中分/偏分或简单束发 | 长发自然散落、青丝如瀑 |
...
| 平民/市井 | 朴素短打 / 粗布衣裙 |
| 宫女/丫鬟 | 简朴宫装 / 婢女装束 |
| **国王/帝王** | **龙袍/帝王常服（保留身份标识色如明黄或玄色，但无复杂纹饰装饰）** |
...
{发色}{发长}，发丝根根分明，{基础造型}，{角色身份对应的发饰描述，贵族/帝王/神祇→发簪步摇/发冠；武士→束发；平民→自然散发或简单束发}，
{角色身份对应的常规古装着装，如：素色长裙/素色长衫/轻便武服/粗布短打}，中国传统色调低饱和色，服装图案以角色描述为准，
...
{特殊效果：月光/金光/云雾/光环等}，
{材质质感：毛发/羽毛/鳞片精细建模，纹理细节超清晰}，
四视图全身立像，纯净中性灰背景，均匀柔光，无硬阴影，
禁止使用人像特写、禁止使用服装/衣领/锁骨描述，
画面中不要有任何文字
```
...
| R9 | **非人类实体例外**：若角色描述为非人类生物（神兽/仙兽/动物等），则 R1-R8 及面容/肤感/发型/服装/人像特写等人类专用约束不适用，必须使用「非人类实体模板」生成提示词 |
...
| X9 | 对非人类实体（神兽/仙兽/动物）使用人类专用的人像特写/锁骨/服装/面容描述 |
