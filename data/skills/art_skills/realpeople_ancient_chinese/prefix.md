...
⚠️ **非人类实体提醒**：本手册默认适用于人类角色。若当前角色描述指向非人类实体（神兽/仙兽/动物等），则「人物基础形象生成·约束手册」中的人类专用约束（面容/肤感/发型/服装/四视图等）不适用，应使用该手册中的「非人类实体模板」生成提示词，但仍需遵循本全局文档的渲染风格、色彩盘和光影约束。
...
| R5 | 纹理必须声明「纹理细节超清晰」 |
| R6 | **非人类实体例外**：若角色描述为非人类生物（神兽/仙兽/动物等），则角色模板中人类专用约束不适用，使用「非人类实体模板」替代 |
