...
export default router.post(
  ...
  async (req, res) => {
    ...
    const projectSettingData = await u.db("o_project").where("id", projectId).select("imageModel", "derivativeImageModel", "imageQuality", "artStyle", "videoRatio", "concurrentCount").first();
