// @routes-hash f54fc5954bc75edd3fd85786d0b422fc
...
import route71 from "./routes/production/storyboard/generateGridPrompt";
import route72 from "./routes/production/storyboard/generateNineGrid";
...
import route91 from "./routes/production/workbench/reorderTracks";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/storyboard/generateGridPrompt", route71);
  app.use("/api/production/storyboard/generateNineGrid", route72);
  ...
  app.use("/api/production/workbench/reorderTracks", route91);
